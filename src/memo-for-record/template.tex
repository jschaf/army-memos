...
\usepackage[showframe,margin=1in,headsep=12pt,headheight=2\baselineskip]{geometry}
...
\usepackage{enumitem}
\setlist{wide, labelwidth=\parindent}
...
linewidth: \convertto{in}{\the \linewidth}

textwidth: \convertto{in}{\the \textwidth}

parindent: \convertto{in}{\the \parindent}

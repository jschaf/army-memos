...
% Acronyms - AR 25-52: Authorized Abbreviations, Brevity Codes, and
% Acronyms
%
...
\newacronym{flipl}{FLIPL}{Financial Liability Investigation of Property Loss}
...
\begin{enumerate}[labelwidth=12pt,labelsep=4pt,leftmargin=0pt,itemindent=16pt,align=left]
  \item I work for \gls{dod}.  Ryan works for \gls{dod}.  I worked on \gls{flipl}.  Kat worked on \glspl{flipl}
